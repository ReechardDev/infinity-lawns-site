...
export const metadata = {
  ...
  description:
    "Reliable mowing, edging, cleanups & seasonal services in Denver, CO.",
};
    ...
    <section className="mx-auto max-w-6xl px-4 py-16 space-y-10">
      <header className="space-y-3">
        ...
        <div className="flex gap-3">
          <Link href="/#quote" className="rounded-xl2 bg-emerald-600 px-5 py-3 text-white">
            Get a Free Quote
          </Link>
          <Link href="/#services" className="rounded-xl2 border px-5 py-3">
            See Services
          </Link>
        </div>
      </header>

      <ul className="grid gap-4 text-sm sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-2xl border bg-white p-6 shadow-sm">
        <h2 className="mb-2 text-xl font-semibold">Service Areas</h2>
